...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "5072262ed7e99822b7685a3ea50d744537192497604511dc"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/cathleen/dev/rails_projects/ziweijixie/public/system/refinery/resources"

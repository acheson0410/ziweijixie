...
Refinery::Pages.configure do |config|
  ...
  config.types.register :home do |home|
    #home.parts = ["Body", "Left Body", "Top Body"]
    config.show_title_in_body = false
  end

  # Configure global page default parts
  config.default_parts = ["Body", "Jumbotron", "Left Body"]

  config.types.register :common do |common|
    common.parts = ["Body", "Jumbotron", "Left Body", "Top Body"]
  end

  # Configure whether to allow adding new pag e parts
